var haarfarbe, bereich, jahre, upload, Kundenname, form, Email, Telefonnummer, optional, thanks;

// Describe this function...
function Check_Form() {
  if (Kundenname == null && Email == null && Telefonnummer == null) {
...
var we_tabs_next_button = '[bloc=next-question]';
    ...
    haarfarbe = getValueFromInput("haarfarbe");
      ...
      $(we_tabs_next_button).addClass(we_tabs_active_class);
      $(".w--tab-active").attr('next-tab',nextTab);
      $($('[data-w-tab=bereich]')).attr('prev-tab',we_activeTab);
    ...
    $("[name=bereich]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      bereich = getValueFromInput("bereich");
    ...
    $("[name=Telefonnummer]").on("input", function () {
    Telefonnummer = getValueFromInput("Telefonnummer");
      Check_Form();
});

    $("[name=Telefonnummer]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      Telefonnummer = getValueFromInput("Telefonnummer");
        Check_Form();
});
